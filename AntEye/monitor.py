...
main_logger = logging.getLogger("AntEye")
...
def main() -> None:
    ...
    if options.dump_resources:
        import pprint
        import AntEye.Alerters.alerter as alerter
        import AntEye.Loggers.logger as logger
        import AntEye.Monitors.monitor as monitor
    ...
    if not options.quiet:
        main_logger.info("=== AntEye v%s", VERSION)
