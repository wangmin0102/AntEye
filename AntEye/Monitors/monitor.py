# coding=utf-8
"""A collection of monitors for the AntEye application.
...
class Monitor:
    ...
    def __init__(
        ...
        self.monitor_logger = logging.getLogger("AntEye.monitor-" + self.name)
    ...
    def __getstate__(self) -> dict:
        """Loggers (the Python kind, not the AntEye kind) can't be serialized.
...
(register, get_class, all_types) = subclass_dict_handler(
    "AntEye.Monitors.monitor", Monitor, "monitor_type"
)
