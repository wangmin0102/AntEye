...
LOGFILE = os.path.join(APP_PATH, "AntEye.log")
...
class AppServerSvc(win32serviceutil.ServiceFramework):
    _svc_name_ = "AntEye"
    _svc_display_name_ = "AntEye"
    _svc_description_ = "A service wrapper for the python AntEye program"
